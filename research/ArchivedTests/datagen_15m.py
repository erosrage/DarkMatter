"""
Download 15-minute OHLCV data for all Robinhood-listed cryptos via yfinance.
yfinance caps 15m intervals at 60 days of history.
Output: research/data/15m/<symbol>_usd_15m.csv  (columns: date, close)
"""
...
OUT_DIR = os.path.join(os.path.dirname(__file__), "data", "15m")
os.makedirs(OUT_DIR, exist_ok=True)

# All Robinhood-listed crypto tickers (yfinance format)
TICKERS = [
...
for ticker in TICKERS:
    ...
    out_path = os.path.join(OUT_DIR, f"{symbol}_usd_15m.csv")
